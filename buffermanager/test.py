...
def test_delete_random(casename, pick):
    ...
    if (result != LARGE_CASE):
        print("FAILED - Stop " + casename + " Test")
        exit()

def test_delete_seq(casename, pick):
    print(casename + " Test")
    arr = list(range(LARGE_CASE))
...
def test_delete_rev(casename, pick):
    print(casename + " Test")
    arr = list(range(LARGE_CASE))
    arr.reverse()
...
def test_delete_chunk(casename, pick):
    print(casename + " Test")
    arr = list(range(LARGE_CASE))
...
print("--------------      Delete Test       --------------")
# test_delete_seq("Sequantial_Delete_Small(2^10)", SMALL_CASE)
# test_delete_seq("Sequantial_Delete_Medium(2^15)", MEDIUM_CASE)
# test_delete_seq("Sequantial_Delete_Large(2^20)", LARGE_CASE)
# test_delete_rev("Reverse_Delete_Small(2^10)", SMALL_CASE)
# test_delete_rev("Reverse_Delete_Medium(2^15)", MEDIUM_CASE)
# test_delete_rev("Reverse_Delete_Large(2^20)", LARGE_CASE)
# test_delete_chunk("Chunk_Delete_Small(2^10)", SMALL_CASE)
# test_delete_chunk("Chunk_Delete_Medium(2^15)", MEDIUM_CASE)
# test_delete_chunk("Chunk_Delete_Large(2^20)", LARGE_CASE)
# test_delete_random("Random_Delete_Small(2^10)", SMALL_CASE)
# test_delete_random("Random_Delete_Medium(2^15)", MEDIUM_CASE)
# test_delete_random("Random_Delete_Large(2^20)", LARGE_CASE)
